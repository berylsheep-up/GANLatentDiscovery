...
class TrainOptions():
    ...
    def initialize(self):
        ...
        parser.add_argument('--walk_type', type=str, default='linear', choices=['NNz', 'linear'], help='type of latent z walk')
        ...
        group.add_argument('--latent', default="z", help="which latent space to use; z or w")
